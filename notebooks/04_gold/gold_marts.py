...
# # Gold · One Taxi fact and four dimensions
...
dbutils.widgets.text("max_valid_distance_miles", "100", "Maximum valid trip distance (miles)")
catalog = dbutils.widgets.get("catalog").strip()
silver_schema = dbutils.widgets.get("silver_schema").strip()
gold_schema = dbutils.widgets.get("gold_schema").strip()
max_valid_distance_miles = distance_limit(dbutils.widgets.get("max_valid_distance_miles"))
